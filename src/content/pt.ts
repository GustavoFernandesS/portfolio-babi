...
export const pt: Content = {
  ...
  hero: {
    ...
    fields: [
      ...
      { label: "formação", value: "Psicologia · Mackenzie" },
    ...
    body: "Estudo Psicologia no Mackenzie. Entrei como trainee na Consultoria RH Junior — empresa júnior formada por alunos da FGV e do Mackenzie — em março de 2026, e cheguei a Consultora de Projetos em junho. Hoje conduzo projetos de recrutamento e seleção, clima, avaliação de desempenho e plano de carreira para empresas clientes: do diagnóstico à devolutiva para a liderança.",
  ...
  timeline: {
    ...
    entries: [
      ...
      },
      {
        ...
        bullets: [
          "Com previsão de conclusão em novembro de 2029.",
